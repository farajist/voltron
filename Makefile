...
OBJS = TextureManager.cpp Vector2D.cpp LoaderParams.cpp GameObject.cpp SDLGameObject.cpp Player.cpp Enemy.cpp InputHandler.cpp GameStateMachine.cpp GameState.cpp PlayState.cpp MenuState.cpp Game.cpp main.cpp
