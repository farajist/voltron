...
OBJS = base64.cpp TextureManager.cpp SoundManager.cpp Collision.cpp CollisionManager.cpp Vector2D.cpp Layer.cpp Level.cpp LevelParser.cpp TileLayer.cpp ObjectLayer.cpp ScrollingBackground.cpp LoaderParams.cpp GameObject.cpp StateParser.cpp GameObjectFactory.cpp ShooterObject.cpp Player.cpp Enemy.cpp AnimatedGraphic.cpp MenuButton.cpp InputHandler.cpp GameStateMachine.cpp GameState.cpp MenuState.cpp PauseState.cpp PlayState.cpp MainMenuState.cpp GameOverState.cpp Game.cpp main.cpp
