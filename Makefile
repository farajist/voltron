...
OBJS = TextureManager.cpp Vector2D.cpp LoaderParams.cpp GameObject.cpp StateParser.cpp GameObjectFactory.cpp SDLGameObject.cpp Player.cpp Enemy.cpp AnimatedGraphic.cpp MenuButton.cpp InputHandler.cpp GameStateMachine.cpp GameState.cpp MenuState.cpp PauseState.cpp PlayState.cpp MainMenuState.cpp GameOverState.cpp Game.cpp main.cpp
...
LIBRARY_PATHS = `sdl2-config --libs` -ltinyxml
